        ...
        <div class="center">
          <header id="main-header">
            ...
            <nav>
              <ul class="menu">
                <li class="menu__item">
                  <Link class="menu__link" href="./quemsomos.html">
                    Quem Somos
                  </Link>
                </li>
                <li class="menu__item">
                  <Link class="menu__link" href="./blog.html">
                    Blog
                  </Link>
                </li>
                <li class="menu__item">
                  <Link class="menu__link" href="./comoFunciona.html">
                    Como Funciona
                  </Link>
                </li>
                <li class="menu__item">
                  <Link class="menu__link" href="./login_usuario.html">
                    Acesse Agora
                  </Link>
                </li>
              </ul>
